...
public class SimpleSectionedRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SimpleSectionedRecyclerViewAdapter(@LayoutRes int sectionResourceId, @IdRes int textResourceId,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int typeView) {
        if (typeView == mSectionResourceId) {
            View view = LayoutInflater.from(parent.getContext()).inflate(typeView, parent, false);
