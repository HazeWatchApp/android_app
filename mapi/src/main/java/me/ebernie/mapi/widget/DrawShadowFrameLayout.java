...
public class DrawShadowFrameLayout extends FrameLayout {
    ...
    public DrawShadowFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mShadowDrawable = a.getDrawable(R.styleable.DrawShadowFrameLayout_ds_shadowDrawable);
        ...
        mShadowVisible = a.getBoolean(R.styleable.DrawShadowFrameLayout_ds_shadowVisible, true);
        setWillNotDraw(!mShadowVisible || mShadowDrawable == null);

        setShadowTopOffset(a.getDimensionPixelSize(R.styleable.DrawShadowFrameLayout_ds_shadowTopOffset, 0));
    ...
    public void setShadowVisible(boolean shadowVisible, boolean animate) {
        if (mShadowVisible == shadowVisible) {
            return;
        }
